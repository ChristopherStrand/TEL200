...
rightclick-Disconnect library-ungroup
Create mechanism-devie type (Device)-kinematics type (other)
Create link (E-stob base as baselink)
Create joint (parentlink (base), childlink (button))
Joint limit -10 mm and 0mm z axis. First position 0 mm z-axis and second -10 mm z-axis. Create new pose with pressed state. Create digital output access level all
